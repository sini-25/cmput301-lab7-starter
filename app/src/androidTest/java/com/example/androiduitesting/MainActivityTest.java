...
// Check if text "Edmonton" is matched with any of the text isplayed on the screen
...
// If this data matches the text we provided then Voila! Our test hould pass
// You can also use anything() in place of s(instanceOf(String.class))
